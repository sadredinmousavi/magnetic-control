...
PARAMS = {
    ...
    "TARGET_SCHEDULE": [
        ...
        (0 * SHAPE_DURATION, np.array([0.00, 0.00]), 1, np.deg2rad(0.0)),
        (1 * SHAPE_DURATION, np.array([0.00, 0.00]), 2, np.deg2rad(0.0)),
        (2 * SHAPE_DURATION, np.array([0.00, 0.00]), 3, np.deg2rad(0.0)),
        (3 * SHAPE_DURATION, np.array([0.00, 0.00]), 5, np.deg2rad(0.0)),
        (4 * SHAPE_DURATION, np.array([0.00, 0.00]), 7, np.deg2rad(0.0)),
